...
public class TableExtractor5 {

    public static void main(String[] args) {
        String inputFilePath = "C:\\Users\\user\\Desktop\\tableIn.txt";
        String outputFilePath = "C:\\Users\\user\\Desktop\\tableOUT1.txt";
        ...
        try {
            ...
            while (tableMatcher.find()) {
                ...
                System.out.println(tableCount+""+rowCount);
            ...
            System.out.println("Table data has been successfully extracted!"+"and Table count is like ");
